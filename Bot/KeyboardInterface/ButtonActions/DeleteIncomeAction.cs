...
public class DeleteIncomeAction : IButtonAction
{
    public async Task Action(Update update, ITelegramBotClient bot, Dictionary<long, string> userCurrentCommand)
    {
        ...
        userCurrentCommand[chatId] = "delete_income";
        ...
        {
            await bot.SendTextMessageAsync(chatId, "Не найдено ни одной записи для удаления");
        }
    }
}